        ...
        <div class="tab-content">
            <article role="tabpanel" class="tab-pane fade active in" id="description" aria-labelledby="description-tab">
                ...
                <div class="course-details">
                    <div class="col-xs-4"><i class="fa fa-fw fa-list"></i> pub[category]</div>
                    <div class="col-xs-4"><i class="fa fa-fw fa-magnet"></i> pub[col_torrent]</div>
                    <div class="col-xs-4"><i class="fa fa-calendar"></i> pub[date]</div>
